...
export const projects: Project[] = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        outcome: "Victory와 PointUp의 판단 모호도를 완벽히 제거하여 제스처 인식 정확도를 크게 개선하였으며, 불필요한 근태 오입력 확률을 현저히 낮췄습니다."
      },
      {
        title: "FeliCa IDm 스마트카드 로컬 캐싱 및 20만 건 대용량 오프라인 고속 매칭 최적화",
        ...
        challenge: "네트워크 단절 시에도 출입이 가능하도록 20만 건에 달하는 대용량 사용자 IDm 리스트를 단말 로컬 DB(SQLCipher)에 저장·매칭해야 했으나, 짧은 갱신 주기로 인해 플랫폼 동기화 시 로컬 I/O 병목 및 단말 UI 스레드 일시 정지(Freezing) 현상이 심하게 일어났습니다.",
        ...
        outcome: "인터넷이 차단된 오프라인 환경에서도 20만 건의 리스트 중 매칭 대상을 0.2초 이내에 검색하는 초고속 로컬 매칭을 달성하고, 플랫폼 동기화 중 단말 오작동을 해결했습니다."
      },
      {
        ...
        outcome: "국내외 다양한 벤더사 출입 통제 컨트롤러 장비와의 물리 비트 호환성 테스트를 100% 통과하여 현장 장비 호환 오류를 종식시켰습니다."
      }
    ],
